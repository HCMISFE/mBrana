 ...
 */
public class InstitutionCustomAdapter extends ArrayAdapter {
    ArrayList<InstitutionModel> objects;
    Context context;

    public InstitutionCustomAdapter(Context context, int resource, ArrayList<InstitutionModel> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.layout_spinneritem, null);
        }

        InstitutionModel institutionModel = objects.get(position);
